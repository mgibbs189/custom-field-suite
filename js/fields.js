(function($) {
    $(function() {
        ...
        $('.cfs_edit_field').on('click', function() {
        ...
        $('.field_form .field_type select').on('change', function() {
            var type = $(this).val();
        ...
        $('.field_form .field_label input').on('blur', function() {
            var val = $(this).val();
        ...
        $('.field_form .field_label input').on('keyup paste', function() {
            var $this = $(this);
            setTimeout(function() {
        ...
        $('.field_form .field_name input').on('keyup', function() {
